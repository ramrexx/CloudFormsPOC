#
# CFME Automate Method: Chef_Dialog_RoleList
#
# Notes: This method uses a kinfe wrapper to build a dynamic dialog that lists Chef roles
#
# Requirements: 
...
# 3. a knife wrapper is recommended to setup the environment (example is in this class)
# 
###################################
begin
  # Method for logging
  def log(level, message)
    @method = 'Chef_Dialog_RoleList'
  ...
  cmd = "/var/www/miq/knife_wrapper.sh role list"
