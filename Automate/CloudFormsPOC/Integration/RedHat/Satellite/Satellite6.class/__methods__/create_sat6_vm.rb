...
if hostgroup_id == "5"
  post_json(url+"smart_class_parameters/249-db_host/override_values/", JSON.generate({"match" =>"fqdn=#{hostname}.local.domb.com",
    "value"       =>db_host,
                                       }))
end

if hostgroup_id == "8"
  post_json(url+"smart_class_parameters/266-hostname_wordpress0/override_values/", JSON.generate({"match" =>"fqdn=#{hostname}.local.domb.com",
                                       "value"       =>hostname_wordpress0,
                                       }))
  post_json(url+"smart_class_parameters/267-hostname_wordpress1/override_values/", JSON.generate({"match" =>"fqdn=#{hostname}.local.domb.com",
                                       "value"       =>hostname_wordpress0,
                                       }))
  post_json(url+"smart_class_parameters/268-ipaddress_wordpress0/override_values/", JSON.generate({"match" =>"fqdn=#{hostname}.local.domb.com",
                                       "value"       =>ipaddress_wordpress0,
                                       }))
  post_json(url+"smart_class_parameters/269-ipaddress_wordpress1/override_values/", JSON.generate({"match" =>"fqdn=#{hostname}.local.domb.com",
                                       "value"       =>ipaddress_wordpress1,
                                       }))
end
