# MountToolsInstaller.rb
#
# Description: This method mounts the VMware Tools CD installer as a CD-ROM for the guest
#
# Reference: https://www.vmware.com/support/developer/vc-sdk/visdk400pubs/ReferenceGuide/vim.VirtualMachine.html#mountToolsInstaller
#
...
# perform MountToolsInstaller
mount_tools_installer_result = client.call(:mount_tools_installer) do
  message({ '_this' => vm.ems_ref, :attributes! => { 'type' => "VirtualMachine"} } )
end
#$evm.log(:warn, "mount_tools_installer_result: #{mount_tools_installer_result.inspect}")
$evm.log(:info, "mount_tools_installer_result: #{mount_tools_installer_result.success?}")
