# servicetemplateprovisionrequest_warning.rb
#
# Author: Kevin Morey <kmorey@redhat.com>
# License: GPL v3
#
# Description: This method is used to email the requester and approver that the service request Quota warning threshold has been reached
#
begin
  ...
  msg = @miq_request.get_option(:service_quota_warn_exceeded) || @miq_request.resource.message || "Request Quota Warning"
