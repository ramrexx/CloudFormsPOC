...
def service_naming(service, dialogs_options_hash)
...
def service_retirement(service, dialogs_options_hash)
...
# Service naming
service_naming(service, dialogs_options_hash)

# Tag Service
service_tagging(service, dialogs_options_hash)

# Set Service Retirement
service_retirement(service, dialogs_options_hash)
