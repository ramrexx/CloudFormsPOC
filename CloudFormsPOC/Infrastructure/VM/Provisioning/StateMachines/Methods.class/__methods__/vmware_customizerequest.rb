#
# Description: This method is used to map Customization Specifications as well as Customization Templates (I.e. kickstart and cloud-init scripts)
#
...
def process_vmware(mapping, prov, template, product, provider)
  ...
  mapping = 0 if product.include?("other")
